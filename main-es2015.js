...
let AppComponent = class AppComponent {
    constructor(route, router, myservice) {
        this.route = route;
        this.router = router;
...
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/ngx-cookie-service.js");
...
let CommndetailsComponent = class CommndetailsComponent {
    constructor(formBuilder, router, http, myservice, route) {
...
CommndetailsComponent.ctorParameters = () => [
...
let CommnslistComponent = class CommnslistComponent {
    constructor(formBuilder, router, http, myservice, route, cookieService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
        this.myservice = myservice;
    ...
    fn_redirect(requestidval) {
        this.router.navigate(['/commndetails', { 'groupid': requestidval }]);
    }
};
CommnslistComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let CommtempdetailsComponent = class CommtempdetailsComponent {
    constructor(formBuilder, router, http, myservice, route) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
...
CommtempdetailsComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let CommtempslistComponent = class CommtempslistComponent {
    constructor(formBuilder, router, http, myservice, route, cookieService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
...
CommtempslistComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let CreatecommnComponent = class CreatecommnComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CreatecommtempComponent = class CreatecommtempComponent {
    constructor(formBuilder, router, http, myservice, route) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
...
CreatecommtempComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let CreategroupComponent = class CreategroupComponent {
    ...
    ngOnInit() {
        ...
        let params = { 'recidval': this.existgroupid };
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                this.collection.push({ "groupname": splitcol[0], "groupid": splitcol[1], "company": splitcol[2], "recid": splitcol[3] });
                            }
                        }
                    }
                    else {
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    this.router.navigate(['/groupdetails', { 'groupid': mesg }]);
                                }
                            }
                        }
                        else {
...
let CreateholidayComponent = class CreateholidayComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CreaterolesComponent = class CreaterolesComponent {
    ...
    ngOnInit() {
        ...
        let params = { 'recidval': this.existroleid };
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                console.log("mesg=" + mesg);
                                var splitcol = mesg.split('$$');
                                this.collection.push({ "rolename": splitcol[0], "rolelevel": splitcol[1], "company": splitcol[2], "roledesc": splitcol[3], "recid": splitcol[4] });
                            }
                        }
                    }
                    else {
    ...
    onClickSubmit(formval) {
        ...
        if (!this.rolesdata.valid) {
            ...
            // validate all form fields
            let params = { 'rolename': formval.rolename, 'company': formval.company, 'rolelevel': formval.rolelevel, 'description': formval.description };
...
CreaterolesComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let CreatesrtatComponent = class CreatesrtatComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CreatestateComponent = class CreatestateComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CreateuserComponent = class CreateuserComponent {
    ...
    ngOnInit() {
        ...
        let params = { 'recidval': this.existusrid };
        this.collection = [];
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                for (var i = 0; i < rolelen - 1; i++) {
                                    ...
                                    this.rolecollection.push({ "rolename": splitrole[0], "roleid": splitrole[1] });
                                }
                                var grpdt = splitmsg[1].split('||');
                                var grplen = grpdt.length;
                                for (var i = 0; i < grplen - 1; i++) {
                                    var splitgrp = grpdt[i].split('$$');
                                    this.grpcollection.push({ "groupname": splitgrp[0], "groupid": splitgrp[1] });
                                }
                            }
                        }
                    }
    ...
    getnxtevlrole(evt) {
        ...
        if (selrlname == 'MD' || selrlname == 'TC') {
            ...
            let nxtval = { 'roleid': evt.target.value };
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    for (var i = 0; i < rolelen - 1; i++) {
                                        var splitrole = roledt[i].split('$$');
                                        this.nextlevelrl.push({ "nxtrlname": splitrole[0], "nxtrlid": splitrole[1] });
                                    }
                                }
                            }
                        }
    ...
    getreportsto(evt) {
        ...
        if (evt.target.value == 0) {
            ...
            console.log("inside of ELSE=" + evt.target.value);
            let repusr = { 'nxtvalid': evt.target.value };
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    for (var i = 0; i < rolelen - 1; i++) {
                                        var splitrole = roledt[i].split('$$');
                                        this.reportstousr.push({ "repusrname": splitrole[0], "repusrid": splitrole[1] });
                                    }
                                }
                            }
                        }
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    this.router.navigate(['/userdetails', { 'userid': mesg }]);
                                }
                            }
                        }
                        else {
...
let CustomerdetailsComponent = class CustomerdetailsComponent {
    constructor(router, http, myservice, route, formBuilder) {
        this.router = router;
        this.http = http;
        this.myservice = myservice;
        this.route = route;
    ...
    ngOnInit() {
        ...
        let params = { 'agreement_no': this.recid };
...
let CustrequestComponent = class CustrequestComponent {
    constructor(formBuilder, router, http, myservice, route) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
    ...
    ngOnInit() {
        ...
        if (this.existreqid == '' || this.existreqid == null) {
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    this.collection.push({ "customer_name": splitcol[0], "customer_mailid": splitcol[1], "customer_mobileno": splitcol[2], "customerid": splitcol[3], "vehicleno": splitcol[4], "request_creation_dt": splitcol[5] });
                                    ...
                                    for (var i = 0; i < reclen; i++) {
                                        ...
                                        console.log("tatarray=" + this.tatarray[i]);
                                        var arrayval = this.tatarray[i];
                                        console.log("arrayval=" + arrayval);
                                        for (var j = 0; j < tatlen - 1; j++) {
                                            //console.log("splitat="+splitat[j]);//{"reqtat": splitat[j]}
                                            if (i == 0) {
                                                this.requestcats.push(splitat[j]);
                                            }
                                            else if (i == 1) {
                                                this.requestsubcats.push(splitat[j]);
                                            }
                                            else {
                                                this.requesttype.push(splitat[j]);
                                            }
                                        }
                                    }
                                }
            ...
            //let params = {'agreement_no':this.AgreementNo};
            let extparams = { 'requestid': this.existreqid };
    ...
    GetFunTatDt(evt) {
        ...
        let params = { 'catval': this.catval, 'subcatval': this.subcatval, 'typecatval': this.typecatval };
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                console.log("mesg=" + mesg);
                                var splitrw = mesg.split('||');
                                this.grpname = splitrw[0];
                                console.log("grpname=" + this.grpname);
                                this.tatdt = splitrw[1];
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                this.router.navigate(['/requestdetails', { 'requestid': mesg }]);
                            }
                        }
                    }
                    else {
...
CustrequestComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let CustserviceComponent = class CustserviceComponent {
    constructor(formBuilder, router, http, myservice, cookieService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
        this.myservice = myservice;
    ...
    onClickSubmit(searchvalue) {
        ...
        if (searchvalue.api_chkbx != "") {
            if (searchvalue.mobileno != '') {
                let api_name = searchvalue.api_chkbx;
                let agreement_no = searchvalue.agreementno;
                let reg_mobile = searchvalue.mobileno;
                ...
                let params = { 'api_name': api_name, 'agreement_no': agreement_no, 'reg_mobile': reg_mobile };
    ...
    verifyCheckBox(event, checkbxval) {
...
let GroupdetailsComponent = class GroupdetailsComponent {
    ...
    ngOnInit() {
        ...
        this.GroupID = this.route.snapshot.paramMap.get('groupid');
        console.log("GroupID=" + this.GroupID);
        let params = { 'recidval': this.GroupID };
...
let HeaderComponent = class HeaderComponent {
    //var $: any;
    constructor(router, myservice, cookieService) {
        this.router = router;
        this.myservice = myservice;
        this.cookieService = cookieService;
        //header_title = '';
    ...
    ngOnInit() {
        ...
        this.myservice.SelmoduleName.subscribe(updatedTitle => {
            this.SelmoduleName = updatedTitle;
        });
    ...
    */
    ...
    navigateToCreateholiday() {
        //this.selmodule = 'Roles'; 
        this.router.navigate(['/createholiday']);
    }
    navigateToViewholidays() {
        //this.selmodule = 'Roles'; 
    ...
    navigateToViewstates() {
        //this.selmodule = 'Roles'; 
        this.router.navigate(['/stateslist']);
    }
    navigateToCreatecomtep() {
        //this.selmodule = 'Roles'; 
        this.router.navigate(['/createcommtemp']);
    }
    navigateToViewcomteps() {
        //this.selmodule = 'Roles'; 
        this.router.navigate(['/commtempslist']);
    }
    navigateToCreatecomn() {
        //this.selmodule = 'Roles'; 
...
let HolidaydetailsComponent = class HolidaydetailsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let HolidayslistComponent = class HolidayslistComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let LoginComponent = class LoginComponent {
    constructor(formBuilder, route, router, myservice, http, cookieService) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
        this.myservice = myservice;
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    this.cookieService.set('username', usrname);
                                    this.cookieService.set('userid', userid);
                                    this.cookieService.set('fullname', fulname);
                                    alert("Successfully Logged-In");
                                    this.router.navigate(['/menu']);
                                }
                                else {
...
let MenuComponent = class MenuComponent {
    ...
    constructor(router, route, http, myservice, cookieService) {
        this.router = router;
        this.route = route;
        this.http = http;
        this.myservice = myservice;
...
let MyserviceService = class MyserviceService {
    ...
    showTodayDate() {
        let ndate = new Date();
        let d = ndate.getDate();
        let m = ndate.getMonth() + 1; //January is 0!
    ...
    httpPostMethod(url, parameter, contentType, token, moduleName) {
...
let RcaComponent = class RcaComponent {
    constructor(formBuilder, router, http, myservice, route) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
    ...
    ngOnInit() {
        ...
        let params = { 'recidval': this.existrecid };
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                console.log("mesg=" + mesg);
                                var splitcol = mesg.split('$$');
                                this.collection.push({ "complaintid": splitcol[0], "rcastatusval": splitcol[1], "why": splitcol[2], "how": splitcol[3], "reasoncode": splitcol[4], "what": splitcol[5], "when": splitcol[6], "remarks": splitcol[7], "recid": splitcol[8] });
                            }
                        }
                    }
                    else {
    ...
    onClickSubmit(formval) {
        ...
        if (!this.rcadata.valid) {
            ...
            // validate all form fields
            let params = { 'complaintid': formval.complaintid, 'rcastatus': formval.rcastatus, 'why': formval.why, 'how': formval.how, 'reasoncode': formval.reasoncode, 'what': formval.what, 'when': formval.when, 'remarks': formval.remarks };
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    this.router.navigate(['/rcadetails', { 'recid': mesg }]);
                                }
                            }
                        }
                        else {
...
let RcadetailsComponent = class RcadetailsComponent {
    constructor(formBuilder, router, http, myservice, route) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
    ...
    ngOnInit() {
        ...
        let params = { 'recidval': this.ComplaintID };
...
RcadetailsComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let RcalistComponent = class RcalistComponent {
    constructor(formBuilder, router, http, myservice, route, cookieService) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.http = http;
...
RcalistComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let RegisterComponent = class RegisterComponent {
    constructor(formBuilder, router, route, myservice) {
        this.formBuilder = formBuilder;
        this.router = router;
        this.route = route;
        this.myservice = myservice;
    ...
    onSubmit() {
        ...
        //   }
        // )
        this.myservice.saveDetails(this.registerForm.value).then((resData) => {
...
let RequestdetailsComponent = class RequestdetailsComponent {
    ...
    ngOnInit() {
        ...
        let params = { 'requestid': this.RequestID };
...
let RequestslistComponent = class RequestslistComponent {
    ...
    GetIndvidualuser(evnt) {
        ...
        if (this.Selchkbx != "Individual") {
            ...
            let nxtval = { 'groupid': evnt.target.value };
                        ...
                        if (resData['status'] == 200) {
                            ...
                            if (emirates != undefined && emirates != null && emirates != "") {
                                ...
                                if (emirates.success) {
                                    ...
                                    for (var i = 0; i < rolelen - 1; i++) {
                                        var splitrole = roledt[i].split('$$');
                                        this.indvidualusrs.push({ "usrname": splitrole[0], "usrid": splitrole[1] });
                                    }
                                }
                            }
                        }
...
RequestslistComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] },
    { type: _myservice_service__WEBPACK_IMPORTED_MODULE_4__["MyserviceService"] },
...
let SrtatdetailsComponent = class SrtatdetailsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SrtatslistComponent = class SrtatslistComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let StateslistComponent = class StateslistComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let UserdetailsComponent = class UserdetailsComponent {
    ...
    ngOnInit() {
        ...
        let params = { 'recidval': this.UserID };
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                console.log("mesg=" + mesg);
                                var splitcol = mesg.split('$$');
                                this.collection.push({ "username": splitcol[0], "lastname": splitcol[1], "firstname": splitcol[2], "company": splitcol[3], "mobileno": splitcol[4], "reportsto": splitcol[5], "grpname": splitcol[6], "usertype": splitcol[7], "product": splitcol[8], "emailid": splitcol[9], "department": splitcol[11], "role": splitcol[10] });
                            }
                        }
                    }
                    else {
                    ...
                    if (resData['status'] == 200) {
                        ...
                        if (emirates != undefined && emirates != null && emirates != "") {
                            ...
                            if (emirates.success) {
                                ...
                                for (var i = 0; i < reclen - 1; i++) {
                                    var splitcol = splitrow[i].split('$$');
                                    this.collection.push({ "username": splitcol[0], "lastname": splitcol[1], "firstname": splitcol[2], "company": splitcol[3], "mobileno": splitcol[4], "reportsto": splitcol[5], "grpname": splitcol[6], "usertype": splitcol[7], "product": splitcol[8], "emailid": splitcol[9], "department": splitcol[11], "role": splitcol[10], "recid": splitcol[12] });
                                }
                            }
                        }
                    }
